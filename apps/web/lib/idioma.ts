...
export const IDIOMAS = ['en', 'zh'] as const;
...
export const NOMBRE_IDIOMA: Record<Idioma, string> = { en: 'EN', zh: '中文' };

/** Código BCP 47 para el atributo lang del documento y para Intl. */
export const LOCALE_IDIOMA: Record<Idioma, string> = { en: 'en-US', zh: 'zh-CN' };
